...
public interface ProfileAppListMoreAction extends r50 {

    public static final class ClearAllAction implements ProfileAppListMoreAction {
    ...
    public static final class DeleteListAction implements ProfileAppListMoreAction {
    ...
    public static final class EditListAction implements ProfileAppListMoreAction {
    ...
    public static final class GetAppPoliciesAction implements ProfileAppListMoreAction {
        public static final GetAppPoliciesAction INSTANCE = new GetAppPoliciesAction();

        private GetAppPoliciesAction() {
        }

        public boolean equals(Object obj) {
            return this == obj || (obj instanceof GetAppPoliciesAction);
        }
        ...
        public String toString() {
            return "GetAppPoliciesAction";
        }
    }

    public static final class ReportListAction implements ProfileAppListMoreAction {
    ...
    public static final class ToastAction implements ProfileAppListMoreAction {
