...
public class RawResultsImpl<T> implements GenericRawResults<T> {
    ...
    public RawResultsImpl(ConnectionSource connectionSource, DatabaseConnection databaseConnection, Class<?> cls, CompiledStatement compiledStatement, GenericRowMapper<T> genericRowMapper, ObjectCache objectCache) throws SQLException {
        SelectIterator<T, Void> selectIterator = new SelectIterator<>(cls, null, genericRowMapper, connectionSource, databaseConnection, compiledStatement, objectCache);
        this.iterator = selectIterator;
        this.columnNames = selectIterator.getRawResults().getColumnNames();
    }

    @Override // com.j256.ormlite.dao.GenericRawResults, com.j256.ormlite.dao.CloseableWrappedIterable, java.lang.AutoCloseable
