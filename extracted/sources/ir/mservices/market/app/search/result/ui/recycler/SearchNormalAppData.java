...
public final class SearchNormalAppData extends SearchApplicationData implements MyketRecyclerData {
    public static final int k = js6.search_normal_app;
    public final SearchSpecialAppDTO i;
    public final String j;

    /* JADX WARN: Illegal instructions before constructor call */
    public SearchNormalAppData(SearchSpecialAppDTO searchSpecialAppDTO, String str, vb7 vb7Var, pv6 pv6Var) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!SearchNormalAppData.class.equals(obj != null ? obj.getClass() : null)) {
            return false;
        }
        js3.n(obj, "null cannot be cast to non-null type ir.mservices.market.app.search.result.ui.recycler.SearchNormalAppData");
        return js3.i(this.i, ((SearchNormalAppData) obj).i);
    }
