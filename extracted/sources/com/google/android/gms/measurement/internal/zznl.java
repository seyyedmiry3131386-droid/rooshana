...
public final class zznl extends zzg {
    ...
    private final void zzaf(Runnable runnable) throws IllegalStateException {
        ...
        zzicVar.zzc();
        if (size >= 1000) {
            t61.u(zzicVar, "Discarding data. Max runnable queue size reached");
            return;
        }
        list.add(runnable);
        this.zzh.zzb(60000L);
    ...
    private final zzr zzah(boolean z) {
        ...
        if (z) {
            ...
            if (zzicVar2.zzd().zzb != null && (pairZzb = zzicVar2.zzd().zzb.zzb()) != null && pairZzb != zzhh.zza) {
                ...
                strZ = bl4.z(new StringBuilder(strValueOf.length() + 1 + String.valueOf(str).length()), strValueOf, ":", str);
            }
        }
        return zzgiVarZzv.zzh(strZ);
    }
    ...
    public final void zzD(gn9 gn9Var) {
        zzg();
        zzb();
        zzaf(new zzmj(this, zzah(false), gn9Var));
    }
    ...
    public final void zzI() {
        ...
        if (listQueryIntentServices == null || listQueryIntentServices.isEmpty()) {
            t61.u(zzicVar, "Unable to use remote or local measurement implementation. Please register the AppMeasurementService service in the app manifest");
            return;
        }
    ...
    */
    ...
    public final void zzM() {
        ...
        zznfVar.zzb();
        try {
            b21.b().c(this.zzu.zzaY(), zznfVar);
        } catch (IllegalArgumentException | IllegalStateException unused) {
        }
        this.zzb = null;
    }

    public final void zzN(gn9 gn9Var, zzbg zzbgVar, String str) {
        zzg();
        zzb();
        zzic zzicVar = this.zzu;
        if (zzicVar.zzk().zzai(12451000) == 0) {
            zzaf(new zzmp(this, zzbgVar, str, gn9Var));
        } else {
            zzicVar.zzaV().zze().zza("Not bundling data. Service unavailable or out of date");
            zzicVar.zzk().zzao(gn9Var, new byte[0]);
        }
    }
    ...
    public final /* synthetic */ void zzQ() {
        ...
        if (zzgbVar == null) {
            t61.u(this.zzu, "Failed to send storage consent settings to service");
            return;
        }
        try {
            zzr zzrVarZzah = zzah(false);
    ...
    public final /* synthetic */ void zzR() {
        zzgb zzgbVar = this.zzb;
        if (zzgbVar == null) {
            t61.u(this.zzu, "Failed to send Dma consent settings to service");
            return;
        }
        try {
            zzr zzrVarZzah = zzah(false);
    ...
    public final /* synthetic */ void zzU(zzr zzrVar, zzaf zzafVar) {
        zzgb zzgbVar = this.zzb;
        if (zzgbVar == null) {
            t61.u(this.zzu, "[sgtm] Discarding data. Failed to update batch upload status.");
            return;
        }
        try {
    ...
    */
    ...
    public final void zzs(gn9 gn9Var, String str, String str2) {
        zzg();
        zzb();
        zzaf(new zzmw(this, str, str2, zzah(false), gn9Var));
    }
    ...
    public final void zzu(gn9 gn9Var, String str, String str2, boolean z) {
        zzg();
        zzb();
        zzaf(new zzmc(this, str, str2, zzah(false), z, gn9Var));
    }
