...
public abstract class Hilt_BaseNewDialogFragment extends DialogFragment implements br2 {
    public r69 Q0;
    ...
    public void H0() {
        ...
        w91 w91Var = ((t91) ((k80) e())).a;
        baseNewDialogFragment.V0 = (x57) w91Var.G.get();
        baseNewDialogFragment.W0 = (lw8) w91Var.E.get();
    }
