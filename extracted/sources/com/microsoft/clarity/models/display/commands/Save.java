...
public final class Save extends DisplayCommand {
    ...
    public MutationPayload$DisplayCommandV2 toProtobufInstance() {
        o oVarBuild = MutationPayload$DisplayCommandV2.newBuilder().a(getType().toProtobufType()).a((MutationPayload$SaveCommandPayload) MutationPayload$SaveCommandPayload.newBuilder().build()).build();
