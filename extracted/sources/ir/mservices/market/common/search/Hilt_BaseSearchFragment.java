...
public abstract class Hilt_BaseSearchFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public void A0() {
        ...
        w91 w91Var = ((t91) ((a90) e())).a;
        baseSearchFragment.F0 = (d04) w91Var.p.get();
        baseSearchFragment.G0 = (x57) w91Var.G.get();
        baseSearchFragment.S0 = (dv2) w91Var.q.get();
        baseSearchFragment.i1 = (lw8) w91Var.E.get();
        baseSearchFragment.j1 = w91Var.G0();
    }
