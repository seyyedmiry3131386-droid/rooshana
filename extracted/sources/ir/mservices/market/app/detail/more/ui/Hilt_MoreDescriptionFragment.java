...
public abstract class Hilt_MoreDescriptionFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public final void A0() {
        ...
        this.h1 = true;
        MoreDescriptionFragment moreDescriptionFragment = (MoreDescriptionFragment) this;
        w91 w91Var = ((t91) ((ux4) e())).a;
        moreDescriptionFragment.F0 = (d04) w91Var.p.get();
        moreDescriptionFragment.G0 = (x57) w91Var.G.get();
        moreDescriptionFragment.S0 = (dv2) w91Var.q.get();
    }
