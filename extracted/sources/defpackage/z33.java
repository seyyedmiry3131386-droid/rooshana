...
public abstract class z33 extends a79 {
    public final AlphaAnimationView v;
    public final View w;
    public final AlphaAnimationView x;

    public z33(ea1 ea1Var, View view, AlphaAnimationView alphaAnimationView, View view2, AlphaAnimationView alphaAnimationView2) {
        super(0, view, ea1Var);
