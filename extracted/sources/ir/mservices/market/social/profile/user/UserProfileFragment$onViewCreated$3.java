...
@tb1(c = "ir.mservices.market.social.profile.user.UserProfileFragment$onViewCreated$3", f = "UserProfileFragment.kt", l = {182}, m = "invokeSuspend", v = 1)
final class UserProfileFragment$onViewCreated$3 extends SuspendLambda implements dp2 {
    public int a;
    public final /* synthetic */ UserProfileFragment b;

    /* JADX INFO: renamed from: ir.mservices.market.social.profile.user.UserProfileFragment$onViewCreated$3$1, reason: invalid class name */
    @tb1(c = "ir.mservices.market.social.profile.user.UserProfileFragment$onViewCreated$3$1", f = "UserProfileFragment.kt", l = {}, m = "invokeSuspend", v = 1)
    final class AnonymousClass1 extends SuspendLambda implements qp2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (!(userProfileFragment.G().F(rr6.apps) instanceof ProfileListFragment) && (accountDto = (AccountDto) userProfileFragment.l1().P.a.getValue()) != null) {
                    g gVarG = userProfileFragment.G();
                    gVarG.getClass();
                    p40 p40Var = new p40(gVarG);
                    int i2 = rr6.apps;
                    int i3 = ProfileListFragment.Z0;
                    p40Var.k(i2, ol3.p(accountDto.getAccountKey(), true), null);
                    p40Var.e();
                }
            } else if (i == 1) {
                ...
                im2 im2Var6 = userProfileFragment.Z0;
                js3.m(im2Var6);
                FrameLayout frameLayout4 = im2Var6.w;
                js3.o(frameLayout4, "movies");
                frameLayout4.setVisibility(0);
                if (!(userProfileFragment.G().F(rr6.movies) instanceof ProfileListFragment) && (accountDto2 = (AccountDto) userProfileFragment.l1().P.a.getValue()) != null) {
                    g gVarG2 = userProfileFragment.G();
                    gVarG2.getClass();
                    p40 p40Var2 = new p40(gVarG2);
                    int i4 = rr6.movies;
                    int i5 = ProfileListFragment.Z0;
                    p40Var2.k(i4, ol3.p(accountDto2.getAccountKey(), false), null);
                    p40Var2.e();
                }
            }
            return tx8.a;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UserProfileFragment$onViewCreated$3(UserProfileFragment userProfileFragment, g51 g51Var) {
        super(1, g51Var);
        this.b = userProfileFragment;
    }
    ...
    public final g51 create(g51 g51Var) {
        return new UserProfileFragment$onViewCreated$3(this.b, g51Var);
    }

    @Override // defpackage.dp2
    public final Object invoke(Object obj) {
        return ((UserProfileFragment$onViewCreated$3) create((g51) obj)).invokeSuspend(tx8.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            UserProfileFragment userProfileFragment = this.b;
            o4 o4Var = new o4(userProfileFragment.m1().x, 9);
