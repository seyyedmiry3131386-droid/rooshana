...
public abstract class Hilt_SelectedItemsFragment extends PagingRecyclerListFragment {
    public r69 V0;
    ...
    public final void A0() {
        ...
        this.X0 = true;
        SelectedItemsFragment selectedItemsFragment = (SelectedItemsFragment) this;
        w91 w91Var = ((t91) ((tm7) e())).a;
        selectedItemsFragment.F0 = (d04) w91Var.p.get();
        selectedItemsFragment.G0 = (x57) w91Var.G.get();
        selectedItemsFragment.K0 = (dv2) w91Var.q.get();
    }
