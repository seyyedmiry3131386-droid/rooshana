...
public final class wn0 {
    ...
    public final void b() {
        ...
        if (length > 0) {
            ...
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                vn0 vn0Var = (vn0) arrayList.get(size);
                int i = vn0Var.c;
                if (i != length) {
                    return;
                }
    ...
    public final l81 c(int i) {
        ...
        return new l81(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, null, null, i6, 1, Integer.MIN_VALUE, f2, i5, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, Integer.MIN_VALUE, 0.0f, 0);
    }
    ...
    public final SpannableString d() {
        ...
        while (true) {
            ...
            vn0 vn0Var = (vn0) arrayList.get(i5);
            boolean z2 = vn0Var.b;
            int i7 = vn0Var.a;
            if (i7 != 8) {
                boolean z3 = i7 == 7;
            ...
            int i8 = vn0Var.c;
            i5++;
            if (i8 != (i5 < arrayList.size() ? ((vn0) arrayList.get(i5)).c : length)) {
                if (i != -1 && !z2) {
