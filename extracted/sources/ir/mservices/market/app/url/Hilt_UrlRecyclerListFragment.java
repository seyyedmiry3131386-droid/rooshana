...
public abstract class Hilt_UrlRecyclerListFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public final void A0() {
        ...
        this.h1 = true;
        UrlRecyclerListFragment urlRecyclerListFragment = (UrlRecyclerListFragment) this;
        w91 w91Var = ((t91) ((u09) e())).a;
        urlRecyclerListFragment.F0 = (d04) w91Var.p.get();
        urlRecyclerListFragment.G0 = (x57) w91Var.G.get();
        urlRecyclerListFragment.S0 = (dv2) w91Var.q.get();
        urlRecyclerListFragment.i1 = (xf5) w91Var.F.get();
    }
