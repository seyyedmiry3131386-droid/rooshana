...
public final class in6 extends z1 implements RandomAccess {
    public static final in6 d = new in6(new Object[0], 0, false);
    public Object[] b;
    public int c;

    public in6(Object[] objArr, int i, boolean z) {
        super(z);
        this.b = objArr;
        this.c = i;
    }
    ...
    public final rr3 g(int i) {
        if (i >= this.c) {
            return new in6(Arrays.copyOf(this.b, i), this.c, true);
        }
