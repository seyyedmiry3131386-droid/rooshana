...
public abstract class Hilt_AppDetailRecommendationFragment extends PagingRecyclerListFragment {
    public r69 V0;
    ...
    public final void A0() {
        ...
        this.X0 = true;
        AppDetailRecommendationFragment appDetailRecommendationFragment = (AppDetailRecommendationFragment) this;
        w91 w91Var = ((t91) ((op) e())).a;
        appDetailRecommendationFragment.F0 = (d04) w91Var.p.get();
        appDetailRecommendationFragment.G0 = (x57) w91Var.G.get();
        appDetailRecommendationFragment.K0 = (dv2) w91Var.q.get();
        appDetailRecommendationFragment.a1 = (c5) w91Var.L.get();
        appDetailRecommendationFragment.b1 = (ra3) w91Var.j1.get();
    }
