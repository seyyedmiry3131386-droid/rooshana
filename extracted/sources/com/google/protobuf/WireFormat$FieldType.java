...
public class WireFormat$FieldType {
    ...
    public static final WireFormat$FieldType f;
    public static final /* synthetic */ WireFormat$FieldType[] g;
    ...
    static {
        ...
        f = wireFormat$FieldType10;
        g = new WireFormat$FieldType[]{wireFormat$FieldType, wireFormat$FieldType2, wireFormat$FieldType3, wireFormat$FieldType4, wireFormat$FieldType5, wireFormat$FieldType6, wireFormat$FieldType7, wireFormat$FieldType8, anonymousClass1, anonymousClass2, anonymousClass3, anonymousClass4, wireFormat$FieldType9, wireFormat$FieldType10, new WireFormat$FieldType("SFIXED32", 14, wireFormat$JavaType2, 5), new WireFormat$FieldType("SFIXED64", 15, wireFormat$JavaType, 1), new WireFormat$FieldType("SINT32", 16, wireFormat$JavaType2, 0), new WireFormat$FieldType("SINT64", 17, wireFormat$JavaType, 0)};
    }
    ...
    public static WireFormat$FieldType[] values() {
        return (WireFormat$FieldType[]) g.clone();
    }
