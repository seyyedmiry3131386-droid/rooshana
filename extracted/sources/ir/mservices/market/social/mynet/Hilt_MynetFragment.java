...
public abstract class Hilt_MynetFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public final void A0() {
        ...
        this.h1 = true;
        MynetFragment mynetFragment = (MynetFragment) this;
        w91 w91Var = ((t91) ((vg5) e())).a;
        mynetFragment.F0 = (d04) w91Var.p.get();
        mynetFragment.G0 = (x57) w91Var.G.get();
        mynetFragment.S0 = (dv2) w91Var.q.get();
        mynetFragment.j1 = (xf5) w91Var.F.get();
    }
