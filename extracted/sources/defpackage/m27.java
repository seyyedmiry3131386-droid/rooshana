...
public abstract class m27 {
    ...
    public static void f(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder sbN = t61.n("Failed making ", d(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            sbN.append(e(e));
            throw new JsonIOException(sbN.toString(), e);
        }
    }
}
