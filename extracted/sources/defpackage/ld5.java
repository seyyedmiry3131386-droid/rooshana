...
import ir.mservices.market.myMarket.recycler.a;

/* JADX INFO: loaded from: classes3.dex */
public final class ld5 extends k06 {
    public qs3 o;
    ...
    public final qg5 I(int i, View view, ViewGroup viewGroup) {
        if (i == MyMarketData.e) {
            qs3 qs3Var = this.o;
            if (qs3Var != null) {
                return new sd5(view, qs3Var);
            }
            js3.V("onClickListener");
            throw null;
        }
        if (i != MyMarketAnimationData.g) {
            if (i == DividerData.k) {
                return new oq1(view);
            }
            return null;
