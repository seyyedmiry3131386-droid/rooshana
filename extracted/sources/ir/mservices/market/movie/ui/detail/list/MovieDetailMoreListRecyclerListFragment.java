...
public final class MovieDetailMoreListRecyclerListFragment extends Hilt_MovieDetailMoreListRecyclerListFragment {
    ...
    public xf5 i1;
    public j84 j1;
    public final bi5 k1 = new bi5(g27.a(o15.class), new n15(0, this));
    public final o79 l1;

    public MovieDetailMoreListRecyclerListFragment() {
        final MovieDetailMoreListRecyclerListFragment$special$$inlined$viewModels$default$1 movieDetailMoreListRecyclerListFragment$special$$inlined$viewModels$default$1 = new MovieDetailMoreListRecyclerListFragment$special$$inlined$viewModels$default$1(this);
        final c24 c24VarB = a.b(LazyThreadSafetyMode.c, new bp2() { // from class: ir.mservices.market.movie.ui.detail.list.MovieDetailMoreListRecyclerListFragment$special$$inlined$viewModels$default$2
            {
                super(0);
            }
            ...
            public final Object invoke() {
                return (x79) movieDetailMoreListRecyclerListFragment$special$$inlined$viewModels$default$1.invoke();
            }
        });
        this.l1 = new o79(g27.a(MovieDetailMoreListViewModel.class), new bp2() { // from class: ir.mservices.market.movie.ui.detail.list.MovieDetailMoreListRecyclerListFragment$special$$inlined$viewModels$default$3
        ...
        }, new bp2() { // from class: ir.mservices.market.movie.ui.detail.list.MovieDetailMoreListRecyclerListFragment$special$$inlined$viewModels$default$5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new bp2() { // from class: ir.mservices.market.movie.ui.detail.list.MovieDetailMoreListRecyclerListFragment$special$$inlined$viewModels$default$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public final String C() {
        String strL = L(rs6.page_name_detail_movie_more);
    ...
    public final String Q0(BaseFragmentContentActivity baseFragmentContentActivity) {
        String headerTitle = ((o15) this.k1.getValue()).a.getHeaderTitle();
        return (headerTitle == null || f88.n0(headerTitle)) ? "" : headerTitle;
    }
    ...
    public final ir.mservices.market.version2.ui.recycler.adapter.a j1() {
        ...
        l45Var.m = new ur4(this, l45Var, 6);
        return l45Var;
    }

    @Override // ir.mservices.market.version2.fragments.recycle.PagingRecyclerListContentFragment
    public final c l1() {
        return (MovieDetailMoreListViewModel) this.l1.getValue();
    }
    ...
    public final PaddingLayoutManager$Padding u1() {
        ...
        if (this.F0.f()) {
            dimensionPixelSize2 -= K().getDimensionPixelSize(pq6.space_8);
        } else {
            dimensionPixelSize3 -= K().getDimensionPixelSize(pq6.space_8);
        }
