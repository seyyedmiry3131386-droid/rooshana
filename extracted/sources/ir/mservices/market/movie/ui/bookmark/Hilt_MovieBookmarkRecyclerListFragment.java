...
public abstract class Hilt_MovieBookmarkRecyclerListFragment extends PagingRecyclerListContentFragment {
    ...
    public final void A0() {
        ...
        w91 w91Var = ((t91) ((d05) e())).a;
        movieBookmarkRecyclerListFragment.F0 = (d04) w91Var.p.get();
        movieBookmarkRecyclerListFragment.G0 = (x57) w91Var.G.get();
        movieBookmarkRecyclerListFragment.S0 = (dv2) w91Var.q.get();
    }
