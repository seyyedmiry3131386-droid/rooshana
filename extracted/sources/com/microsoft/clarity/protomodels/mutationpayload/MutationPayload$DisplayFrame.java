...
public final class MutationPayload$DisplayFrame extends com.google.protobuf.o implements InterfaceC0143u {
    ...
    static {
        ...
        com.google.protobuf.o.registerDefaultInstance(MutationPayload$DisplayFrame.class, mutationPayload$DisplayFrame);
    }

    private MutationPayload$DisplayFrame() {
    }

    private void addAllCommands(Iterable<? extends MutationPayload$DisplayCommand> iterable) {
        ensureCommandsIsMutable();
        com.google.protobuf.a.addAll((Iterable) iterable, (List) this.commands_);
    }

    private void addAllImages(Iterable<? extends MutationPayload$Image> iterable) {
        ensureImagesIsMutable();
        com.google.protobuf.a.addAll((Iterable) iterable, (List) this.images_);
    }

    private void addAllPaints(Iterable<? extends MutationPayload$Paint> iterable) {
        ensurePaintsIsMutable();
        com.google.protobuf.a.addAll((Iterable) iterable, (List) this.paints_);
    }

    private void addAllPaths(Iterable<? extends MutationPayload$Path> iterable) {
        ensurePathsIsMutable();
        com.google.protobuf.a.addAll((Iterable) iterable, (List) this.paths_);
    }

    private void addAllSubPictures(Iterable<? extends MutationPayload$DisplayFrame> iterable) {
        ensureSubPicturesIsMutable();
        com.google.protobuf.a.addAll((Iterable) iterable, (List) this.subPictures_);
    }

    private void addAllTextBlobs(Iterable<? extends MutationPayload$TextBlob> iterable) {
        ensureTextBlobsIsMutable();
        com.google.protobuf.a.addAll((Iterable) iterable, (List) this.textBlobs_);
    }

    private void addAllTypefaces(Iterable<? extends MutationPayload$Typeface> iterable) {
        ensureTypefacesIsMutable();
        com.google.protobuf.a.addAll((Iterable) iterable, (List) this.typefaces_);
    }

    private void addAllVertices(Iterable<? extends MutationPayload$Vertices> iterable) {
    ...
    private void mergeViewHierarchy(MutationPayload$ViewHierarchy mutationPayload$ViewHierarchy) {
        ...
        if (mutationPayload$ViewHierarchy2 == null || mutationPayload$ViewHierarchy2 == MutationPayload$ViewHierarchy.getDefaultInstance()) {
            ...
            this.viewHierarchy_ = (MutationPayload$ViewHierarchy) ((w1) MutationPayload$ViewHierarchy.newBuilder(this.viewHierarchy_).mergeFrom((com.google.protobuf.o) mutationPayload$ViewHierarchy)).buildPartial();
        }
        this.bitField0_ |= 1;
    }

    public static C0141t newBuilder() {
        return (C0141t) DEFAULT_INSTANCE.createBuilder();
    }

    public static MutationPayload$DisplayFrame parseDelimitedFrom(InputStream inputStream) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static MutationPayload$DisplayFrame parseFrom(ByteBuffer byteBuffer) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    private void setSystemBackgroundColor(int i) {
        this.bitField0_ |= 256;
    ...
    private void setViewHierarchy(MutationPayload$ViewHierarchy mutationPayload$ViewHierarchy) {
        mutationPayload$ViewHierarchy.getClass();
        this.viewHierarchy_ = mutationPayload$ViewHierarchy;
        this.bitField0_ |= 1;
    }
    ...
    public MutationPayload$DisplayCommand getCommands(int i) {
        return (MutationPayload$DisplayCommand) this.commands_.get(i);
    }
    ...
    public InterfaceC0132o getCommandsOrBuilder(int i) {
        return (InterfaceC0132o) this.commands_.get(i);
    }

    public List<? extends InterfaceC0132o> getCommandsOrBuilderList() {
        return this.commands_;
    }
    ...
    public MutationPayload$DisplayFrame getSubPictures(int i) {
        return (MutationPayload$DisplayFrame) this.subPictures_.get(i);
    }
    ...
    public InterfaceC0143u getSubPicturesOrBuilder(int i) {
        return (InterfaceC0143u) this.subPictures_.get(i);
    }

    public List<? extends InterfaceC0143u> getSubPicturesOrBuilderList() {
        return this.subPictures_;
    }
    ...
    public static C0141t newBuilder(MutationPayload$DisplayFrame mutationPayload$DisplayFrame) {
        return (C0141t) DEFAULT_INSTANCE.createBuilder(mutationPayload$DisplayFrame);
    }

    public static MutationPayload$DisplayFrame parseDelimitedFrom(InputStream inputStream, h72 h72Var) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, h72Var);
    }

    public static MutationPayload$DisplayFrame parseFrom(ByteBuffer byteBuffer, h72 h72Var) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseFrom(DEFAULT_INSTANCE, byteBuffer, h72Var);
    }

    public static MutationPayload$DisplayFrame parseFrom(ByteString byteString) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseFrom(DEFAULT_INSTANCE, byteString);
    }
    ...
    public static MutationPayload$DisplayFrame parseFrom(ByteString byteString, h72 h72Var) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseFrom(DEFAULT_INSTANCE, byteString, h72Var);
    }

    public static MutationPayload$DisplayFrame parseFrom(byte[] bArr) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static MutationPayload$DisplayFrame parseFrom(byte[] bArr, h72 h72Var) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseFrom(DEFAULT_INSTANCE, bArr, h72Var);
    }

    public static MutationPayload$DisplayFrame parseFrom(InputStream inputStream) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static MutationPayload$DisplayFrame parseFrom(InputStream inputStream, h72 h72Var) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseFrom(DEFAULT_INSTANCE, inputStream, h72Var);
    }

    public static MutationPayload$DisplayFrame parseFrom(lu0 lu0Var) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseFrom(DEFAULT_INSTANCE, lu0Var);
    }

    public static MutationPayload$DisplayFrame parseFrom(lu0 lu0Var, h72 h72Var) {
        return (MutationPayload$DisplayFrame) com.google.protobuf.o.parseFrom(DEFAULT_INSTANCE, lu0Var, h72Var);
    }
}
