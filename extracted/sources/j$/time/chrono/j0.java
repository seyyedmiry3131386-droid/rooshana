...
public final class j0 extends d {
    ...
    public final j$.time.temporal.t k(j$.time.temporal.p pVar) {
        ...
        return j$.time.temporal.t.e(1L, J() <= 0 ? (-(tVar.a + 543)) + 1 : 543 + tVar.d);
    }

    @Override // j$.time.temporal.TemporalAccessor
    public final long w(j$.time.temporal.p pVar) {
        if (pVar instanceof j$.time.temporal.a) {
            int i = i0.a[((j$.time.temporal.a) pVar).ordinal()];
            if (i == 4) {
                int iJ = J();
                if (iJ < 1) {
                    iJ = 1 - iJ;
    ...
    */
    public final j$.time.chrono.j0 c(long r8, j$.time.temporal.p r10) {
        /*
            r7 = this;
        ...
        L9f:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.j0.c(long, j$.time.temporal.p):j$.time.chrono.j0");
    }

    @Override // j$.time.chrono.d
    /* JADX INFO: renamed from: I */
    public final b j(j$.time.temporal.n nVar) {
        return (j0) super.j(nVar);
    }
    ...
    public final j0 L(j$.time.g gVar) {
        return gVar.equals(this.a) ? this : new j0(gVar);
    }
