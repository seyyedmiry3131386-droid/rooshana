...
public class NestedScrollView extends FrameLayout implements mm5, jm5, ScrollingView {
    public static final float D = (float) (Math.log(0.78d) / Math.log(0.9d));
    public static final hw1 E = new hw1(4);
    ...
    private ng7 getScrollFeedbackProvider() {
        if (this.g == null) {
            this.g = new ng7(this);
        }
        return this.g;
    ...
    */
    ...
    public final void j(int i) {
        if (getChildCount() > 0) {
            ...
            if (Build.VERSION.SDK_INT >= 35) {
                hz1.d(this, Math.abs(this.d.getCurrVelocity()));
            }
        }
    }
    ...
    public final boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.l) {
            if (m91.x(motionEvent, 2)) {
                axisValue = motionEvent.getAxisValue(9);
                i = 9;
                width = (int) motionEvent.getX();
            } else if (m91.x(motionEvent, 4194304)) {
            ...
            if (axisValue != 0.0f) {
                s(-((int) (getVerticalScrollFactorCompat() * axisValue)), i, motionEvent, width, 1, m91.x(motionEvent, 8194));
                if (i == 0) {
                    return true;
                }
    ...
    */
    ...
    public void setOnScrollChangeListener(im5 im5Var) {
        this.B = im5Var;
    }
    ...
    public final boolean t(EdgeEffect edgeEffect, int i) {
        ...
        float fE0 = yq2.e0(edgeEffect) * getHeight();
    ...
    public final boolean v(MotionEvent motionEvent) {
        boolean z;
        EdgeEffect edgeEffect = this.e;
        if (yq2.e0(edgeEffect) != 0.0f) {
            yq2.t0(edgeEffect, 0.0f, motionEvent.getX() / getWidth());
            z = true;
        } else {
            z = false;
        }
        EdgeEffect edgeEffect2 = this.f;
        if (yq2.e0(edgeEffect2) == 0.0f) {
            return z;
        }
        yq2.t0(edgeEffect2, 0.0f, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, rp6.nestedScrollViewStyle);
    }
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.t = new int[2];
        this.u = new int[2];
        this.C = new jo1(getContext(), new c35(2, this));
        int i2 = Build.VERSION.SDK_INT;
        if (i2 >= 31) {
            edgeEffect = cz1.a(context, attributeSet);
        } else {
            edgeEffect = new EdgeEffect(context);
        }
        this.e = edgeEffect;
        if (i2 >= 31) {
            edgeEffect2 = cz1.a(context, attributeSet);
        } else {
