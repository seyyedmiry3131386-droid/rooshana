...
public abstract class Hilt_MovieSeasonsRecyclerListFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public final void A0() {
        ...
        this.h1 = true;
        MovieSeasonsRecyclerListFragment movieSeasonsRecyclerListFragment = (MovieSeasonsRecyclerListFragment) this;
        w91 w91Var = ((t91) ((b75) e())).a;
        movieSeasonsRecyclerListFragment.F0 = (d04) w91Var.p.get();
        movieSeasonsRecyclerListFragment.G0 = (x57) w91Var.G.get();
        movieSeasonsRecyclerListFragment.S0 = (dv2) w91Var.q.get();
        movieSeasonsRecyclerListFragment.i1 = (ec9) w91Var.C.get();
    }
