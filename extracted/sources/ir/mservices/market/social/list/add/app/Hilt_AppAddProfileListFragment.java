...
public abstract class Hilt_AppAddProfileListFragment extends BaseAddProfileListFragment {
    public r69 d1;
    ...
    public final void A0() {
        ...
        this.f1 = true;
        AppAddProfileListFragment appAddProfileListFragment = (AppAddProfileListFragment) this;
        w91 w91Var = ((t91) ((fm) e())).a;
        appAddProfileListFragment.F0 = (d04) w91Var.p.get();
        appAddProfileListFragment.G0 = (x57) w91Var.G.get();
        appAddProfileListFragment.V0 = (lw8) w91Var.E.get();
        appAddProfileListFragment.W0 = (dv2) w91Var.q.get();
    }
