...
public abstract class Hilt_SecurityShieldRecyclerFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public final void A0() {
        ...
        w91 w91Var = ((t91) ((gl7) e())).a;
        securityShieldRecyclerFragment.F0 = (d04) w91Var.p.get();
        securityShieldRecyclerFragment.G0 = (x57) w91Var.G.get();
        securityShieldRecyclerFragment.S0 = (dv2) w91Var.q.get();
        securityShieldRecyclerFragment.i1 = (xf5) w91Var.F.get();
    }
