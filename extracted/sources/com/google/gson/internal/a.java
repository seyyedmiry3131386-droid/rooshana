...
public abstract class a {
    ...
    public static Type b(Type type) {
        if (type instanceof Class) {
            ...
            return cls.isArray() ? new GsonTypes$GenericArrayTypeImpl(b(cls.getComponentType())) : cls;
        }
    ...
    public static Type g(Type type, Class cls, Class cls2) {
        ...
        if (cls2.isAssignableFrom(cls)) {
            return i(type, cls, e(type, cls, cls2), new HashMap());
        }
    ...
    public static ParameterizedType h(Class cls, Type... typeArr) {
        return new GsonTypes$ParameterizedTypeImpl(null, cls, typeArr);
    }
    ...
    */
    public static java.lang.reflect.Type i(java.lang.reflect.Type r10, java.lang.Class r11, java.lang.reflect.Type r12, java.util.HashMap r13) {
        /*
            Method dump skipped, instruction units count: 330
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.a.i(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.HashMap):java.lang.reflect.Type");
    }
