...
public class DatabaseFieldConfig {
    ...
    private String findIndexName(String str) {
        return this.columnName == null ? dw1.s(bl4.E(str, "_"), this.fieldName, "_idx") : dw1.s(bl4.E(str, "_"), this.columnName, "_idx");
    }
    ...
    private static String methodFromField(Field field, String str, DatabaseType databaseType, boolean z) {
        ...
        StringBuilder sbE = bl4.E(str, databaseType.upCaseString(name.substring(0, 1), z));
        sbE.append((CharSequence) name, 1, name.length());
        return sbE.toString();
    }
