...
public abstract class rt6 {
    ...
    public static int[] ColorStateListItem = {R.attr.color, R.attr.alpha, R.attr.lStar, ir.mservices.market.R.attr.alpha, ir.mservices.market.R.attr.lStar};
    public static int[] FontFamily = {ir.mservices.market.R.attr.fontProviderAuthority, ir.mservices.market.R.attr.fontProviderCerts, ir.mservices.market.R.attr.fontProviderFallbackQuery, ir.mservices.market.R.attr.fontProviderFetchStrategy, ir.mservices.market.R.attr.fontProviderFetchTimeout, ir.mservices.market.R.attr.fontProviderPackage, ir.mservices.market.R.attr.fontProviderQuery, ir.mservices.market.R.attr.fontProviderSystemFontFamily};
    public static int[] FontFamilyFont = {R.attr.font, R.attr.fontWeight, R.attr.fontStyle, R.attr.ttcIndex, R.attr.fontVariationSettings, ir.mservices.market.R.attr.font, ir.mservices.market.R.attr.fontStyle, ir.mservices.market.R.attr.fontVariationSettings, ir.mservices.market.R.attr.fontWeight, ir.mservices.market.R.attr.ttcIndex};
    ...
    public static int[] PercentLayout_Layout = {ir.mservices.market.R.attr.layout_aspectRatio, ir.mservices.market.R.attr.layout_heightPercent, ir.mservices.market.R.attr.layout_marginBottomPercent, ir.mservices.market.R.attr.layout_marginEndPercent, ir.mservices.market.R.attr.layout_marginLeftPercent, ir.mservices.market.R.attr.layout_marginPercent, ir.mservices.market.R.attr.layout_marginRightPercent, ir.mservices.market.R.attr.layout_marginStartPercent, ir.mservices.market.R.attr.layout_marginTopPercent, ir.mservices.market.R.attr.layout_widthPercent};
}
