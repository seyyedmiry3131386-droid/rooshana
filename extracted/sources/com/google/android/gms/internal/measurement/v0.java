    ...
    */
    public static boolean a(byte[] r6, int r7, int r8) {
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.v0.a(byte[], int, int):boolean");
    }
    ...
    public static int c(byte[] bArr, String str, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char cCharAt;
