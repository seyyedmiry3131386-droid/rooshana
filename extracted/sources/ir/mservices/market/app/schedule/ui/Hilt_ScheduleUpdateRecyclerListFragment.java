...
public abstract class Hilt_ScheduleUpdateRecyclerListFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public final void A0() {
        ...
        this.h1 = true;
        ScheduleUpdateRecyclerListFragment scheduleUpdateRecyclerListFragment = (ScheduleUpdateRecyclerListFragment) this;
        w91 w91Var = ((t91) ((ze7) e())).a;
        scheduleUpdateRecyclerListFragment.F0 = (d04) w91Var.p.get();
        scheduleUpdateRecyclerListFragment.G0 = (x57) w91Var.G.get();
        scheduleUpdateRecyclerListFragment.S0 = (dv2) w91Var.q.get();
        scheduleUpdateRecyclerListFragment.i1 = w91Var.Z();
    }
