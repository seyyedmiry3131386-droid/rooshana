...
public final class yk6 implements ai5 {
    public final DialogDataModel a;
    public final ProfileListTitleData b;
    public final String c;

    public yk6(DialogDataModel dialogDataModel, ProfileListTitleData profileListTitleData, String str) {
    ...
    public static final yk6 fromBundle(Bundle bundle) {
        if (!t61.B(bundle, "bundle", yk6.class, "data")) {
        ...
        if (bundle.containsKey("accountKey")) {
            return new yk6(dialogDataModel, profileListTitleData, bundle.getString("accountKey"));
        }
    ...
    public final boolean equals(Object obj) {
        ...
        yk6 yk6Var = (yk6) obj;
        return js3.i(this.a, yk6Var.a) && js3.i(this.b, yk6Var.b) && js3.i(this.c, yk6Var.c);
    }
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("ProfileAppListMoreFragmentArgs(data=");
        sb.append(this.a);
