...
public final class q35 extends b {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q35(View view, GraphicUtils$Dimension graphicUtils$Dimension, boolean z, og5 og5Var, og5 og5Var2) {
    ...
    public final float D(NestedRecyclerData nestedRecyclerData) {
        ...
        this.a.getResources().getValue(pq6.medium_movie_card_count, typedValue, true);
