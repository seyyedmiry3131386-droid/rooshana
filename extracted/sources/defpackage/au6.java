...
public abstract class au6 {
    ...
    public static int ZoomageView_zoomage_animateOnReset = 0;
    public static int ZoomageView_zoomage_autoCenter = 1;
    public static int ZoomageView_zoomage_autoResetMode = 2;
    public static int ZoomageView_zoomage_doubleTapToZoom = 3;
    public static int ZoomageView_zoomage_doubleTapToZoomScaleFactor = 4;
    public static int ZoomageView_zoomage_maxScale = 5;
    public static int ZoomageView_zoomage_minScale = 6;
    public static int ZoomageView_zoomage_restrictBounds = 7;
    public static int ZoomageView_zoomage_translatable = 8;
    public static int ZoomageView_zoomage_zoomable = 9;
