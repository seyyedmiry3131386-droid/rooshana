...
public final class GAIDOptOutEvent extends AnalyticsEvent {
    private final String gaid;
    private final EventType type;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GAIDOptOutEvent(long j, ScreenMetadata screenMetadata, String str) {
        super(j, screenMetadata);
        js3.p(screenMetadata, "screenMetadata");
        js3.p(str, "gaid");
        this.gaid = str;
        this.type = EventType.GAIDOptOut;
    }
