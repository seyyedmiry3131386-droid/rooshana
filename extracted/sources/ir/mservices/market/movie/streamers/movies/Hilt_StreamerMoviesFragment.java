...
public abstract class Hilt_StreamerMoviesFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public final void A0() {
        ...
        this.h1 = true;
        StreamerMoviesFragment streamerMoviesFragment = (StreamerMoviesFragment) this;
        w91 w91Var = ((t91) ((x68) e())).a;
        streamerMoviesFragment.F0 = (d04) w91Var.p.get();
        streamerMoviesFragment.G0 = (x57) w91Var.G.get();
        streamerMoviesFragment.S0 = (dv2) w91Var.q.get();
    }
