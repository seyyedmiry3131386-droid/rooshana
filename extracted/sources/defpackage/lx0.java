...
public final class lx0 extends t1 {
    ...
    public final dr3 a(er3 er3Var, q0 q0Var) {
        ...
        if (er3Var.b.d()) {
            ...
            return new dr3(new NavIntentDirections.MyReview(new yd5(1)));
        }
    ...
    public final boolean b(q0 q0Var) {
        List listD;
        return super.b(q0Var) && (listD = q0Var.d()) != null && listD.contains(q0Var.b(rs6.external_intent_path_segments_complete_review));
    }
}
