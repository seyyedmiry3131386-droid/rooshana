...
public final class px4 extends c26 {
    public final double[] v;
    public final double[][] w;
    public final double[][] x;
    public final double[] y;

    public px4(double[] dArr, double[][] dArr2) {
    ...
    public static double R(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d7 * d2;
        double d9 = 3.0d * d7;
    ...
    public final double B(double d) {
        ...
        while (i < length - 1) {
            ...
            if (d2 <= d3) {
                ...
                double[][] dArr3 = this.x;
                return Q(d5, (d2 - d4) / d5, d6, d7, dArr3[i][0], dArr3[i2][0]) / d5;
            }
            i = i2;
        }
        return 0.0d;
        ...
        while (i < length - 1) {
            ...
            if (d2 <= d3) {
                ...
                for (int i3 = 0; i3 < length2; i3++) {
                    ...
                    double[][] dArr4 = this.x;
                    dArr[i3] = Q(d5, d6, d7, d8, dArr4[i][i3], dArr4[i2][i3]) / d5;
                }
                return;
            }
            i = i2;
            ...
            if (d < d5) {
                ...
                while (i2 < i) {
                    ...
                    if (d < d7) {
                        ...
                        double[][] dArr3 = this.x;
                        return R(d8, d9, d10, d11, dArr3[i2][0], dArr3[i3][0]);
                    }
                    i2 = i3;
                }
                return 0.0d;
        ...
        while (i4 < length - 1) {
            ...
            if (d < d4) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr5 = this.x;
                    dArr[i] = R(d6, d7, d8, d9, dArr5[i4][i], dArr5[i6][i]);
                    i++;
                }
                return;
            }
        ...
        while (i4 < length - 1) {
            ...
            if (d < d4) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr4 = this.x;
                    fArr[i] = (float) R(d6, d7, d8, d9, dArr4[i4][i], dArr4[i6][i]);
                    i++;
                }
                return;
            }
