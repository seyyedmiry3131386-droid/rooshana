...
public final class RadiotapDataTxAttenuation implements RadiotapPacket.RadiotapData {
    ...
    public boolean equals(Object obj) {
        ...
        return RadiotapDataTxAttenuation.class.isInstance(obj) && this.txAttenuation == ((RadiotapDataTxAttenuation) obj).txAttenuation;
    }
    ...
    private RadiotapDataTxAttenuation(byte[] bArr, int i, int i2) throws IllegalRawDataException {
        if (i2 >= 2) {
            this.txAttenuation = ByteArrays.getShort(bArr, i, ByteOrder.LITTLE_ENDIAN);
            return;
        }
        StringBuilder sbA = o40.A(ErrorDTO.CODE_PACKAGE_NAME_NOT_IN_MYKET_ERROR, "The data is too short to build a RadiotapTxAttenuation (2 bytes). data: ");
    ...
    public String toString(String str) {
        ...
        String strZ = o40.z("line.separator", str, "TX attenuation: ", str, sb);
