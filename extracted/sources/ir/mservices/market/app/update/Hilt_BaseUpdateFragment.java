...
public abstract class Hilt_BaseUpdateFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public final void A0() {
        ...
        w91 w91Var = ((t91) ((v90) e())).a;
        baseUpdateFragment.F0 = (d04) w91Var.p.get();
        baseUpdateFragment.G0 = (x57) w91Var.G.get();
        baseUpdateFragment.S0 = (dv2) w91Var.q.get();
        baseUpdateFragment.m1 = (ps1) w91Var.w.get();
        baseUpdateFragment.n1 = (ir.mservices.market.version2.manager.a) w91Var.D.get();
        baseUpdateFragment.o1 = (wt) w91Var.z.get();
    }
