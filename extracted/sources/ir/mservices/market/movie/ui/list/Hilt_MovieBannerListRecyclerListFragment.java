...
public abstract class Hilt_MovieBannerListRecyclerListFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public final void A0() {
        ...
        this.h1 = true;
        MovieBannerListRecyclerListFragment movieBannerListRecyclerListFragment = (MovieBannerListRecyclerListFragment) this;
        w91 w91Var = ((t91) ((b05) e())).a;
        movieBannerListRecyclerListFragment.F0 = (d04) w91Var.p.get();
        movieBannerListRecyclerListFragment.G0 = (x57) w91Var.G.get();
        movieBannerListRecyclerListFragment.S0 = (dv2) w91Var.q.get();
        movieBannerListRecyclerListFragment.i1 = (xf5) w91Var.F.get();
        movieBannerListRecyclerListFragment.j1 = (qa3) w91Var.H0.get();
    }
