...
public final class zzpp extends zzjf {
    ...
    public static ArrayList zzas(List list) {
        ...
        while (it.hasNext()) {
            ...
            bundle.putString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN, zzahVar.zzb);
    ...
    */
    ...
    public final jl4 zzT() {
        if (this.zzg == null) {
            Context contextZzaY = this.zzu.zzaY();
            js3.p(contextZzaY, "context");
            is3 is3VarA = a.a(contextZzaY);
            this.zzg = is3VarA != null ? new MeasurementManagerFutures$Api33Ext5JavaImpl(is3VarA) : null;
        }
        return this.zzg;
    }
    ...
    public final boolean zzW() {
        ...
        if (this.zzh == null) {
            ...
            try {
                num = (Integer) jl4VarZzT.a().get(10000L, TimeUnit.MILLISECONDS);
                if (num != null) {
                    try {
                        if (num.intValue() == 1) {
                            z = true;
    ...
    public final boolean zzY(String str) {
        zzg();
        zzic zzicVar = this.zzu;
        if (((Context) sg9.a(zzicVar.zzaY()).a).checkCallingOrSelfPermission(str) == 0) {
            return true;
        }
    ...
    public final zzbg zzac(String str, String str2, Bundle bundle, String str3, long j, boolean z, boolean z2) {
        ...
        Bundle bundleZzF = zzF(str, str2, bundle2, Collections.singletonList("_o"), true);
        if (z) {
    ...
    public final boolean zzad(Context context, String str) {
        ...
        try {
            PackageInfo packageInfoC = sg9.a(context).c(64, str);
    ...
    public final int zzah() {
        if (this.zzi == null) {
            ...
            int i2 = 0;
            try {
                i2 = contextZzaY.getPackageManager().getPackageInfo("com.google.android.gms", 0).versionCode;
            } catch (PackageManager.NameNotFoundException unused) {
                t0.m("GooglePlayServicesUtil", "Google Play services is missing.");
            }
            this.zzi = Integer.valueOf(i2 / 1000);
        }
        return this.zzi.intValue();
    }

    public final int zzai(int i) {
        return hu2.b.b(this.zzu.zzaY(), 12451000);
    }
    ...
    public final void zzal(gn9 gn9Var, String str) {
        Bundle bundle = new Bundle();
    ...
    public final void zzam(gn9 gn9Var, long j) {
        Bundle bundle = new Bundle();
        bundle.putLong("r", j);
        try {
            gn9Var.I(bundle);
    ...
    public final void zzan(gn9 gn9Var, int i) {
        Bundle bundle = new Bundle();
        bundle.putInt("r", i);
        try {
            gn9Var.I(bundle);
    ...
    public final void zzao(gn9 gn9Var, byte[] bArr) {
        Bundle bundle = new Bundle();
    ...
    public final void zzap(gn9 gn9Var, boolean z) {
        Bundle bundle = new Bundle();
    ...
    public final void zzaq(gn9 gn9Var, Bundle bundle) {
        try {
            gn9Var.I(bundle);
        } catch (RemoteException e) {
    ...
    public final void zzar(gn9 gn9Var, ArrayList arrayList) {
        Bundle bundle = new Bundle();
    ...
    public final void zzba() {
        ...
        if (jNextLong == 0) {
            ...
            if (jNextLong == 0) {
                t61.C(this.zzu, "Utils falling back to Random for random id");
            }
        }
