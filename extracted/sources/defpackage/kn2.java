...
public abstract class kn2 {
    ...
    public abstract void u(d dVar, Object obj, qm0 qm0Var, Runnable runnable);

    public void v(Object obj, qm0 qm0Var, b7 b7Var, Runnable runnable) {
        ((ih1) runnable).run();
    }
    ...
    public void d(Object obj, g7 g7Var) {
    }
