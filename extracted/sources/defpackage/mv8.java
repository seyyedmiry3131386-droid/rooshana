...
public final class mv8 extends ReplacementSpan {
    public final lv8 b;
    public TextPaint e;
    ...
    public mv8(lv8 lv8Var) {
        wu8.l(lv8Var, "rasterizer cannot be null");
        this.b = lv8Var;
    }
    ...
    */
    public final void draw(android.graphics.Canvas r19, java.lang.CharSequence r20, int r21, int r22, float r23, int r24, int r25, int r26, android.graphics.Paint r27) {
        ...
        L94:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mv8.draw(android.graphics.Canvas, java.lang.CharSequence, int, int, float, int, int, int, android.graphics.Paint):void");
    }
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        ...
        lv8 lv8Var = this.b;
        this.d = fAbs / (lv8Var.b().a(14) != 0 ? ((ByteBuffer) r8.d).getShort(r1 + r8.a) : (short) 0);
        nv4 nv4VarB = lv8Var.b();
        int iA = nv4VarB.a(14);
        if (iA != 0) {
            ((ByteBuffer) nv4VarB.d).getShort(iA + nv4VarB.a);
        }
        short s = (short) ((lv8Var.b().a(12) != 0 ? ((ByteBuffer) r5.d).getShort(r7 + r5.a) : (short) 0) * this.d);
        this.c = s;
