...
public final class ks9 extends tr9 implements RandomAccess, ns9, et9 {
    public static final int[] d;
    public static final ks9 e;
    public int[] b;
    public int c;
    ...
    static {
        int[] iArr = new int[0];
        d = iArr;
        e = new ks9(iArr, 0, false);
    }

    public ks9(int[] iArr, int i, boolean z) {
        super(z);
        this.b = iArr;
        this.c = i;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        collection.getClass();
        if (!(collection instanceof ks9)) {
            return super.addAll(collection);
        }
        ks9 ks9Var = (ks9) collection;
        int i = ks9Var.c;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(ks9Var.b, 0, this.b, this.c, ks9Var.c);
        this.c = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final ks9 Y0(int i) {
        if (i >= this.c) {
            return new ks9(i == 0 ? d : Arrays.copyOf(this.b, i), this.c, true);
        }
