...
public final class z87 extends x87 {
    ...
    public z87(View view) {
        ...
        super(null, view, avatarImageView, myketTextView, myketTextView2, frameLayout, myketTextView3, myketTextView4, myketTextView5, buzzProgressImageView, myketTextView6, constraintLayout, buzzProgressImageView2, myketTextView7, myketTextView8, buzzProgressImageView3, myketTextView9, (BuzzProgressImageView) objArrI0[19], (MyketTextView) objArrI0[8], (MyketImageButton) objArrI0[2], (MyketTextView) objArrI0[3], (MyketRatingBar) objArrI0[17], (SmallRegularTextButton) objArrI0[1], (SmallRegularTextButton) objArrI0[7], (ImageView) objArrI0[16]);
        this.S = -1L;
        this.w.setTag(null);
        this.x.setTag(null);
        this.y.setTag(null);
