...
public interface WindowAreaComponentApi3Requirements {
    ...
    void startRearDisplayPresentationSession(Activity activity2, Consumer<Integer> consumer);

    void startRearDisplaySession(Activity activity2, Consumer<Integer> consumer);
}
