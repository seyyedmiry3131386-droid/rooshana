...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet, int i) {
        ...
        this.g = new Rect();
        TypedArray typedArrayD = vj8.d(context, attributeSet, yt6.TextInputEditText, i, mt6.Widget_Design_TextInputEditText, new int[0]);
        setTextInputLayoutFocusedRectEnabled(typedArrayD.getBoolean(yt6.TextInputEditText_textInputLayoutFocusedRectEnabled, false));
        typedArrayD.recycle();
    }
}
