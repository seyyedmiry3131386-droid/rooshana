...
public final class h52 extends FilterInputStream {
    public static final byte[] c = {-1, -31, 0, 28, 69, 120, 105, 102, 0, 0, 77, 77, 0, 0, 0, 0, 0, 8, 0, 1, 1, 18, 0, 2, 0, 0, 0, 1, 0};
    public static final int d = 31;
    public final byte a;
    public int b;

    public h52(int i, InputStream inputStream) {
        super(inputStream);
        if (i < -1 || i > 8) {
            throw new IllegalArgumentException(rm7.n(i, "Cannot add invalid orientation: "));
        }
        this.a = (byte) i;
    }
