...
public abstract class n29 {
    ...
    public static final mi b = new mi(8);
    public static final mi c = new mi(9);
    public static final mi d = new mi(10);
    public static final mi e = new mi(11);
    ...
    public static void a(Path path, float f2, float f3, float f4) {
        ...
        if (!(f2 == 1.0f && f3 == 0.0f) && length >= 1.0f && Math.abs((f3 - f2) - 1.0f) >= 0.01d) {
            ...
            if (fMin >= length && fMax >= length) {
                fMin = aw4.d(fMin, length);
                fMax = aw4.d(fMax, length);
            }
            if (fMin < 0.0f) {
                fMin = aw4.d(fMin, length);
            }
