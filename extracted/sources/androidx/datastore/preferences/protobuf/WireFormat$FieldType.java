...
public class WireFormat$FieldType {
    public static final WireFormat$FieldType c;
    public static final WireFormat$FieldType d;
    public static final WireFormat$FieldType e;
    public static final /* synthetic */ WireFormat$FieldType[] f;
    ...
    /* JADX INFO: renamed from: androidx.datastore.preferences.protobuf.WireFormat$FieldType$1, reason: invalid class name */
    public enum AnonymousClass1 extends WireFormat$FieldType {
    }

    /* JADX INFO: renamed from: androidx.datastore.preferences.protobuf.WireFormat$FieldType$2, reason: invalid class name */
    public enum AnonymousClass2 extends WireFormat$FieldType {
    }

    /* JADX INFO: renamed from: androidx.datastore.preferences.protobuf.WireFormat$FieldType$3, reason: invalid class name */
    public enum AnonymousClass3 extends WireFormat$FieldType {
    }

    /* JADX INFO: renamed from: androidx.datastore.preferences.protobuf.WireFormat$FieldType$4, reason: invalid class name */
    ...
    public static WireFormat$FieldType[] values() {
        return (WireFormat$FieldType[]) f.clone();
    }
}
