...
public final class RadiotapDataDbAntennaSignal implements RadiotapPacket.RadiotapData {
    ...
    private RadiotapDataDbAntennaSignal(byte[] bArr, int i, int i2) throws IllegalRawDataException {
        if (i2 >= 1) {
            this.antennaSignal = ByteArrays.getByte(bArr, i);
            return;
        }
        StringBuilder sbA = o40.A(ErrorDTO.CODE_PACKAGE_NAME_NOT_IN_MYKET_ERROR, "The data is too short to build a RadiotapDbAntennaSignal (1 bytes). data: ");
    ...
    public String toString(String str) {
        ...
        String strZ = o40.z("line.separator", str, "dB antenna signal: ", str, sb);
