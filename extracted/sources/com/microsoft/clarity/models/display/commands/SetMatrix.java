...
public final class SetMatrix extends DisplayCommand {
    ...
    public MutationPayload$DisplayCommandV2 toProtobufInstance() {
        o oVarBuild = MutationPayload$DisplayCommandV2.newBuilder().a(getType().toProtobufType()).a((MutationPayload$SetMatrixCommandPayload) MutationPayload$SetMatrixCommandPayload.newBuilder().a(this.matrix).build()).build();
