...
public abstract class Hilt_BaseAddProfileListFragment extends BaseContentFragment {
    public r69 S0;
    ...
    public void A0() {
        ...
        w91 w91Var = ((t91) ((u50) e())).a;
        baseAddProfileListFragment.F0 = (d04) w91Var.p.get();
        baseAddProfileListFragment.G0 = (x57) w91Var.G.get();
        baseAddProfileListFragment.V0 = (lw8) w91Var.E.get();
        baseAddProfileListFragment.W0 = (dv2) w91Var.q.get();
    }
