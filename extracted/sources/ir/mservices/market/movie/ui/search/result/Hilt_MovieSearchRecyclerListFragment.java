...
public abstract class Hilt_MovieSearchRecyclerListFragment extends PagingRecyclerListFragment {
    ...
    public final void A0() {
        ...
        w91 w91Var = ((t91) ((q65) e())).a;
        movieSearchRecyclerListFragment.F0 = (d04) w91Var.p.get();
        movieSearchRecyclerListFragment.G0 = (x57) w91Var.G.get();
        movieSearchRecyclerListFragment.K0 = (dv2) w91Var.q.get();
        movieSearchRecyclerListFragment.Y0 = (lw8) w91Var.E.get();
        movieSearchRecyclerListFragment.Z0 = (f65) w91Var.I0.get();
    }
