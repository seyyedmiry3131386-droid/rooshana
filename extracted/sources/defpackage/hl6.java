...
public final class hl6 implements ze2 {
    public final /* synthetic */ ProfileListFragment a;

    public hl6(ProfileListFragment profileListFragment) {
    ...
    public final Object emit(Object obj, g51 g51Var) {
        ...
        if (z) {
            ...
            hh2 hh2Var = new hh2(profileListFragment.F(), translatedMessage);
            hh2Var.G();
            hh2.H(hh2Var);
        } else if (n99Var instanceof l99) {
            int i2 = ProfileListFragment.Z0;
            if (profileListFragment.J0.g() instanceof ReportDialogFragment) {
                profileListFragment.J0.q();
            }
            pk5.g(profileListFragment.J0, new NavIntentDirections.AlertButtonComponent(new dd(new DialogDataModel(profileListFragment.U0(), "DIALOG_KEY_NO_RESULT", null, 12), null, yq6.ic_thanks_report, null, profileListFragment.K().getString(rs6.thanks_report_dialog_text), null, profileListFragment.L(rs6.button_ok), sj8.b().c, sj8.b().d, sj8.b(), 0)), -1);
