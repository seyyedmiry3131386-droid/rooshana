...
public abstract class Hilt_BasePlayerVideoFragment extends BaseContentFragment {
    public r69 S0;
    ...
    public void A0() {
        ...
        w91 w91Var = ((t91) ((q80) e())).a;
        basePlayerVideoFragment.F0 = (d04) w91Var.p.get();
        basePlayerVideoFragment.G0 = (x57) w91Var.G.get();
        basePlayerVideoFragment.W0 = (dv2) w91Var.q.get();
    }
