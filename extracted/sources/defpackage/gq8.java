...
public final class gq8 {
    ...
    public gq8(double d, double d2, double d3, double d4, double d5, double d6, double d7) {
        this.a = d;
        this.b = d2;
        this.c = d3;
        this.d = d4;
    ...
    public final boolean equals(Object obj) {
        ...
        gq8 gq8Var = (gq8) obj;
        return Double.compare(this.a, gq8Var.a) == 0 && Double.compare(this.b, gq8Var.b) == 0 && Double.compare(this.c, gq8Var.c) == 0 && Double.compare(this.d, gq8Var.d) == 0 && Double.compare(this.e, gq8Var.e) == 0 && Double.compare(this.f, gq8Var.f) == 0 && Double.compare(this.g, gq8Var.g) == 0;
    }
    ...
    public /* synthetic */ gq8(double d, double d2, double d3, double d4, double d5) {
