...
public final class j35 extends g35 {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j35(View view, GraphicUtils$Dimension graphicUtils$Dimension, boolean z) {
    ...
    public final float D(NestedRecyclerData nestedRecyclerData) {
        ...
        this.a.getResources().getValue(pq6.medium_movie_banner_card_count, typedValue, true);
