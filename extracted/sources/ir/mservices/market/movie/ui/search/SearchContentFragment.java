...
public final class SearchContentFragment extends BaseSearchFragment {
    ...
    public final bi5 r1 = new bi5(g27.a(wh7.class), new yw6(9, this));
    public final o79 s1;
    ...
    public SearchContentFragment() {
        ...
        final c24 c24VarB = a.b(LazyThreadSafetyMode.c, new bp2() { // from class: ir.mservices.market.movie.ui.search.SearchContentFragment$special$$inlined$viewModels$default$2
            {
                super(0);
            }
        ...
        this.s1 = new o79(g27.a(SearchIntentViewModel.class), new bp2() { // from class: ir.mservices.market.movie.ui.search.SearchContentFragment$special$$inlined$viewModels$default$3
        ...
        }, new bp2() { // from class: ir.mservices.market.movie.ui.search.SearchContentFragment$special$$inlined$viewModels$default$5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new bp2() { // from class: ir.mservices.market.movie.ui.search.SearchContentFragment$special$$inlined$viewModels$default$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public final String Q0(BaseFragmentContentActivity baseFragmentContentActivity) {
        String strConcat;
        String string = baseFragmentContentActivity.getResources().getString(rs6.page_name_movie_search);
        String str = ((wh7) this.r1.getValue()).a;
        if (f88.n0(str)) {
            str = null;
        }
    ...
    public final String U1() {
        String strL = L(rs6.search_movie_hint);
        js3.o(strL, "getString(...)");
        return strL;
    }
    ...
    public final void b2() {
        dw1.y("search_speech_movie_intent");
    }
    ...
    public final void k0(View view, Bundle bundle) {
        ...
        ir.mservices.market.version2.core.utils.a.d(this, Lifecycle$State.d, new SearchContentFragment$onViewCreated$1(this, null));
        ir.mservices.market.version2.core.utils.a.d(this, Lifecycle$State.d, new SearchContentFragment$onViewCreated$2(this, null));
    }
