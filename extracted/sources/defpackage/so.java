...
public final class so {
    ...
    public static Method d(String str) {
        try {
            ...
            t0.n("ACTVAutoSizeHelper", "Failed to retrieve TextView#" + str + "() method", e);
            return null;
        }
    }
    ...
    public static Object e(String str, Object obj, Object obj2) {
        try {
            ...
            t0.n("ACTVAutoSizeHelper", "Failed to invoke TextView#" + str + "() method", e);
            return obj2;
        }
    }
    ...
    public final int c(RectF rectF) {
        ...
        while (i3 <= i) {
            ...
            StaticLayout staticLayoutA = oo.a(text, (Layout.Alignment) e("getLayoutAlignment", textView, Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), maxLines, textView, this.h, this.k);
        ...
        if (fApplyDimension != textView.getPaint().getTextSize()) {
            ...
            if (textView.getLayout() != null) {
                ...
                try {
                    ...
                    t0.n("ACTVAutoSizeHelper", "Failed to invoke TextView#nullLayouts() method", e);
                }
                if (zIsInLayout) {
