...
public final class ProfileAppListMoreFragment extends Hilt_ProfileAppListMoreFragment {
    ...
    public xf5 i1;
    public final bi5 j1 = new bi5(g27.a(yk6.class), new n15(25, this));
    public final o79 k1;

    public ProfileAppListMoreFragment() {
        final ProfileAppListMoreFragment$special$$inlined$viewModels$default$1 profileAppListMoreFragment$special$$inlined$viewModels$default$1 = new ProfileAppListMoreFragment$special$$inlined$viewModels$default$1(this);
        final c24 c24VarB = a.b(LazyThreadSafetyMode.c, new bp2() { // from class: ir.mservices.market.social.profile.listMore.app.list.ProfileAppListMoreFragment$special$$inlined$viewModels$default$2
            {
                super(0);
            }
            ...
            public final Object invoke() {
                return (x79) profileAppListMoreFragment$special$$inlined$viewModels$default$1.invoke();
            }
        });
        this.k1 = new o79(g27.a(ProfileAppListMoreViewModel.class), new bp2() { // from class: ir.mservices.market.social.profile.listMore.app.list.ProfileAppListMoreFragment$special$$inlined$viewModels$default$3
        ...
        }, new bp2() { // from class: ir.mservices.market.social.profile.listMore.app.list.ProfileAppListMoreFragment$special$$inlined$viewModels$default$5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new bp2() { // from class: ir.mservices.market.social.profile.listMore.app.list.ProfileAppListMoreFragment$special$$inlined$viewModels$default$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        if (str.equalsIgnoreCase(Q1())) {
            ...
            if ("DIALOG_KEY_DELETE_LIST".equalsIgnoreCase(str2)) {
                if (dialogDataModel.d == DialogResult.a) {
                    S1().r(ProfileAppListMoreAction.DeleteListAction.INSTANCE);
                }
                ...
                ProfileAppListMoreViewModel profileAppListMoreViewModelS1 = S1();
                int i = bundle.getInt("SELECT_INDEX");
                SparseArray sparseArray = new SparseArray();
                sparseArray.put(0, ReportListType.APP_TITLE);
                Object obj = sparseArray.get(i);
                js3.o(obj, "get(...)");
                profileAppListMoreViewModelS1.r(new ProfileAppListMoreAction.ReportListAction(string, (ReportListType) obj));
            }
        }
    }
    ...
    public final String C() {
        String strL = L(rs6.page_name_app_list_more);
    ...
    public final String Q1() {
        return dw1.n("ProfileAppListMoreFragment_", this.H0);
    }

    public final yk6 R1() {
        return (yk6) this.j1.getValue();
    }

    public final ProfileAppListMoreViewModel S1() {
        return (ProfileAppListMoreViewModel) this.k1.getValue();
    }
    ...
    public final boolean g1(MenuItem menuItem) {
        ...
        if (itemId == rr6.edit_list) {
            S1().r(ProfileAppListMoreAction.GetAppPoliciesAction.INSTANCE);
            return true;
        }
        ...
        if (itemId == rr6.report_list) {
            ProfileApplicationListDto profileApplicationListDto = R1().b.b;
            Bundle bundleG = is3.g(new Pair("BUNDLE_KEY_LIST_TYPE", profileApplicationListDto != null ? profileApplicationListDto.getKey() : null), new Pair("BUNDLE_KEY_IS_APP", Boolean.TRUE));
    ...
    public final ir.mservices.market.version2.ui.recycler.adapter.a j1() {
        vk6 vk6Var = new vk6((K().getDimensionPixelSize(pq6.item_space) + t61.e(K(), pq6.horizontal_space_outer, 2, p3.g(F()).a)) / v1(), v1(), 0);
        vk6Var.o = new ts5(7, this);
        return vk6Var;
    }
    ...
    public final void k0(View view, Bundle bundle) {
        ...
        ir.mservices.market.version2.core.utils.a.d(this, Lifecycle$State.d, new ProfileAppListMoreFragment$onViewCreated$1(this, null));
        ir.mservices.market.version2.core.utils.a.d(this, Lifecycle$State.d, new ProfileAppListMoreFragment$onViewCreated$2(this, null));
        ir.mservices.market.version2.core.utils.a.d(this, Lifecycle$State.d, new ProfileAppListMoreFragment$onViewCreated$3(this, null));
        ir.mservices.market.version2.core.utils.a.d(this, Lifecycle$State.d, new ProfileAppListMoreFragment$onViewCreated$4(this, null));
        ir.mservices.market.version2.core.utils.a.d(this, Lifecycle$State.d, new ProfileAppListMoreFragment$onViewCreated$5(this, null));
    }
    ...
    @Override // ir.mservices.market.version2.fragments.recycle.PagingRecyclerListContentFragment
    public final int v1() {
        return K().getInteger(ds6.profile_app_list_more_max_span);
    }
}
