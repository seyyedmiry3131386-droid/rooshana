...
public abstract class Hilt_MovieDetailRecyclerListFragment extends PagingRecyclerListContentFragment {
    ...
    public final void A0() {
        ...
        w91 w91Var = ((t91) ((w15) e())).a;
        movieDetailRecyclerListFragment.F0 = (d04) w91Var.p.get();
        movieDetailRecyclerListFragment.G0 = (x57) w91Var.G.get();
        movieDetailRecyclerListFragment.S0 = (dv2) w91Var.q.get();
        movieDetailRecyclerListFragment.i1 = (c5) w91Var.L.get();
        movieDetailRecyclerListFragment.j1 = (fw0) w91Var.i1.get();
        movieDetailRecyclerListFragment.k1 = (d56) w91Var.U.get();
        movieDetailRecyclerListFragment.l1 = (ec9) w91Var.C.get();
        movieDetailRecyclerListFragment.m1 = (lw8) w91Var.E.get();
    }
