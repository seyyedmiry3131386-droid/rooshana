...
public final class k35 extends g35 {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k35(View view, GraphicUtils$Dimension graphicUtils$Dimension, boolean z) {
    ...
    public final float D(NestedRecyclerData nestedRecyclerData) {
        ...
        this.a.getResources().getValue(pq6.small_movie_banner_card_count, typedValue, true);
