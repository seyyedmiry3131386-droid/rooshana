...
public final class BigMovieOvalButton extends MyketProgressButton {
    public int b;
    public int c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BigMovieOvalButton(Context context, AttributeSet attributeSet) {
        ...
        setHeight(context.getResources().getDimensionPixelSize(pq6.big_movie_button_size));
        setPadding(context.getResources().getDimensionPixelSize(pq6.space_12));
        setProgressSize(context.getResources().getDimensionPixelSize(pq6.space_24));
        a();
    }
