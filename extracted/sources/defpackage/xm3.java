...
public final class xm3 {
    ...
    public xm3(TextInputLayout textInputLayout) {
        Context context = textInputLayout.getContext();
        this.g = context;
        this.h = textInputLayout;
        this.m = context.getResources().getDimensionPixelSize(oq6.design_textinput_caption_translate_y);
        this.a = ub1.G(context, vp6.motionDurationShort4, 217);
        this.b = ub1.G(context, vp6.motionDurationMedium4, 167);
        this.c = ub1.G(context, vp6.motionDurationShort4, 167);
        this.d = ub1.H(context, vp6.motionEasingEmphasizedDecelerateInterpolator, yk.d);
        int i = vp6.motionEasingEmphasizedDecelerateInterpolator;
        LinearInterpolator linearInterpolator = yk.a;
        this.e = ub1.H(context, i, linearInterpolator);
        this.f = ub1.H(context, vp6.motionEasingLinearInterpolator, linearInterpolator);
    }
    ...
    public final void b() {
        if (this.i != null) {
            ...
            if (textInputLayout.getEditText() != null) {
                ...
                Context context = this.g;
                boolean z = ja1.z(context);
                LinearLayout linearLayout = this.i;
                int i = oq6.material_helper_text_font_1_3_padding_horizontal;
                int paddingStart = editText.getPaddingStart();
                if (z) {
                    paddingStart = context.getResources().getDimensionPixelSize(i);
                }
                int i2 = oq6.material_helper_text_font_1_3_padding_top;
                int dimensionPixelSize = context.getResources().getDimensionPixelSize(oq6.material_helper_text_default_padding_top);
                if (z) {
                    dimensionPixelSize = context.getResources().getDimensionPixelSize(i2);
                }
                int i3 = oq6.material_helper_text_font_1_3_padding_horizontal;
    ...
    public final void i(int i, int i2, boolean z) {
        ...
        if (z) {
            ...
            animatorSet.addListener(new vm3(this, i2, e(i), i, e(i2)));
            animatorSet.start();
        } else if (i != i2) {
