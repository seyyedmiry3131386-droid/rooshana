...
public final class zj extends Drawable.ConstantState {
    public boolean A;
    ...
    public zj(zj zjVar, ck ckVar, Resources resources) {
        this.i = false;
        this.l = false;
        this.w = true;
        this.y = 0;
        this.z = 0;
        this.a = ckVar;
        this.b = resources != null ? resources : zjVar != null ? zjVar.b : null;
        int i = zjVar != null ? zjVar.c : 0;
        int i2 = ck.t;
        ...
        if (zjVar != null) {
            ...
            if (zjVar.c == i) {
                if (zjVar.j) {
                    this.k = zjVar.k != null ? new Rect(zjVar.k) : null;
                    this.j = true;
                }
                if (zjVar.m) {
                    this.n = zjVar.n;
            ...
            this.h = zjVar.h;
            SparseArray sparseArray = zjVar.f;
            if (sparseArray != null) {
