...
public final class BigCircleButton extends MyketProgressButton {
    ...
    public BigCircleButton(Context context, AttributeSet attributeSet) {
        ...
        setWidth(context.getResources().getDimensionPixelSize(pq6.big_button_height));
        setProgressSize(context.getResources().getDimensionPixelSize(pq6.margin_default_v2_triple));
    }
    ...
    public void setIcon(Drawable drawable) {
        int dimensionPixelSize = getResources().getDimensionPixelSize(pq6.big_circle_button_icon_size);
        if (drawable != null) {
