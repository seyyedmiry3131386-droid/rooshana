...
public abstract class Hilt_BaseAccountUsersFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public void A0() {
        ...
        this.h1 = true;
        BaseAccountUsersFragment baseAccountUsersFragment = (BaseAccountUsersFragment) this;
        w91 w91Var = ((t91) ((q50) e())).a;
        baseAccountUsersFragment.F0 = (d04) w91Var.p.get();
        baseAccountUsersFragment.G0 = (x57) w91Var.G.get();
        baseAccountUsersFragment.S0 = (dv2) w91Var.q.get();
    }
