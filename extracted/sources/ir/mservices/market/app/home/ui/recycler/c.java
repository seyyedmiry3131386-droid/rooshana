...
public final class c extends g70 {
    ...
    public final void s(MyketRecyclerData myketRecyclerData) {
        ...
        View view = this.a;
        js3.o(view, "itemView");
        bt2.G(cc7.q(view), null, null, new HomeVideoDigestedViewHolder$onAttach$1(homeVideoData, this, null), 3);
        bt2.G(cc7.q(view), null, null, new HomeVideoDigestedViewHolder$onAttach$2(homeVideoData, this, null), 3);
    }
    ...
    public final void t(MyketRecyclerData myketRecyclerData) {
        ...
        myketVideoView4.setVideoListener(new nc2(this, homeVideoData, 6));
        ...
        d95 d95Var = z().v;
        FrameLayout frameLayout = d95Var.y;
        ...
        d95Var.v.setData(application.getAdInfoDto());
        xf5 xf5Var = this.B;
        if (xf5Var == null) {
            js3.V("myketUIUtils");
            throw null;
