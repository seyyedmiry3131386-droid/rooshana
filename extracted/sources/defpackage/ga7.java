...
public final class ga7 extends Drawable {
    public float a;
    ...
    public ga7(ColorStateList colorStateList, float f) {
        this.a = f;
    ...
    public final void b(Rect rect) {
        ...
        rect2.set(rect);
        if (this.f) {
            rect2.inset((int) Math.ceil(ha7.a(this.e, this.a, this.g)), (int) Math.ceil(ha7.b(this.e, this.a, this.g)));
            rectF.set(rect2);
        }
    }
