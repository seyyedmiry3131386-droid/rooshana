...
public abstract class Hilt_ReceiveAppRecyclerListFragment extends PagingRecyclerListContentFragment {
    ...
    public final void A0() {
        ...
        w91 w91Var = ((t91) ((nw6) e())).a;
        receiveAppRecyclerListFragment.F0 = (d04) w91Var.p.get();
        receiveAppRecyclerListFragment.G0 = (x57) w91Var.G.get();
        receiveAppRecyclerListFragment.S0 = (dv2) w91Var.q.get();
        receiveAppRecyclerListFragment.i1 = (fw4) w91Var.M.get();
        receiveAppRecyclerListFragment.j1 = (xf5) w91Var.F.get();
    }
