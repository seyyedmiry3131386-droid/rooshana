...
public final class ao3 extends InputConnectionWrapper {
    public final /* synthetic */ v4 a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ao3(InputConnection inputConnection, v4 v4Var) {
            ...
            try {
                ...
                try {
                    ...
                    if (uri != null && clipDescription != null) {
                        zE = v4Var.e(new ca7(uri, clipDescription, uri2), i, bundle2);
                    }
                    if (resultReceiver != null) {
                        resultReceiver.send(zE ? 1 : 0, null);
                    }
                } catch (Throwable th) {
                    th = th;
                    if (resultReceiver != null) {
