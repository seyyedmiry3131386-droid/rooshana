...
public class RuntimeExceptionDao<T, ID> implements Dao<T, ID> {
    ...
    public void assignEmptyForeignCollection(T t, String str) {
        try {
            ...
            logMessage(e, dw1.n("assignEmptyForeignCollection threw exception on ", str));
    ...
    public int create(T t) {
        try {
            ...
            logMessage(e, o40.x(t, "create threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public T createIfNotExists(T t) {
        try {
            ...
            logMessage(e, o40.x(t, "createIfNotExists threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public Dao.CreateOrUpdateStatus createOrUpdate(T t) {
        try {
            ...
            logMessage(e, o40.x(t, "createOrUpdate threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public int delete(T t) {
        try {
            ...
            logMessage(e, o40.x(t, "delete threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public int deleteById(ID id) {
        try {
            ...
            logMessage(e, o40.x(id, "deleteById threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public int executeRaw(String str, String... strArr) {
        try {
            ...
            logMessage(e, dw1.n("executeRaw threw exception on: ", str));
            throw new RuntimeException(e);
        }
    }
    ...
    public int executeRawNoArgs(String str) {
        try {
            ...
            logMessage(e, dw1.n("executeRawNoArgs threw exception on: ", str));
            throw new RuntimeException(e);
        }
    }
    ...
    public ID extractId(T t) {
        try {
            ...
            logMessage(e, o40.x(t, "extractId threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public <FT> ForeignCollection<FT> getEmptyForeignCollection(String str) {
        try {
            ...
            logMessage(e, dw1.n("getEmptyForeignCollection threw exception on ", str));
            throw new RuntimeException(e);
        }
    }
    ...
    public boolean idExists(ID id) {
        try {
            ...
            logMessage(e, o40.x(id, "idExists threw exception on "));
            throw new RuntimeException(e);
        }
    }
    ...
    public List<T> queryForEq(String str, Object obj) {
        try {
            ...
            logMessage(e, dw1.n("queryForEq threw exception on: ", str));
            throw new RuntimeException(e);
        }
    }
    ...
    public T queryForId(ID id) {
        try {
            ...
            logMessage(e, o40.x(id, "queryForId threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public List<T> queryForMatching(T t) {
        try {
            ...
            logMessage(e, o40.x(t, "queryForMatching threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public List<T> queryForMatchingArgs(T t) {
        try {
            ...
            logMessage(e, o40.x(t, "queryForMatchingArgs threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public T queryForSameId(T t) {
        try {
            ...
            logMessage(e, o40.x(t, "queryForSameId threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public GenericRawResults<String[]> queryRaw(String str, String... strArr) {
        try {
            ...
            logMessage(e, dw1.n("queryRaw threw exception on: ", str));
            throw new RuntimeException(e);
        }
    }
    ...
    public long queryRawValue(String str, String... strArr) {
        try {
            ...
            logMessage(e, dw1.n("queryRawValue threw exception on: ", str));
            throw new RuntimeException(e);
        }
    }
    ...
    public int refresh(T t) {
        try {
            ...
            logMessage(e, o40.x(t, "refresh threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public void setObjectCache(boolean z) {
        try {
            ...
            logMessage(e, bl4.x("setObjectCache(", ") threw exception", z));
            throw new RuntimeException(e);
        }
    }
    ...
    public int update(T t) {
        try {
            ...
            logMessage(e, o40.x(t, "update threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public int updateId(T t, ID id) {
        try {
            ...
            logMessage(e, o40.x(t, "updateId threw exception on: "));
            throw new RuntimeException(e);
        }
    }
    ...
    public int updateRaw(String str, String... strArr) {
        try {
            ...
            logMessage(e, dw1.n("updateRaw threw exception on: ", str));
            throw new RuntimeException(e);
        }
    }
