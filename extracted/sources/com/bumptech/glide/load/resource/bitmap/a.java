...
public final class a extends FilterInputStream {
    ...
    public a(InputStream inputStream, dr3 dr3Var) {
        super(inputStream);
        this.d = -1;
        this.f = dr3Var;
        this.a = (byte[]) dr3Var.d(65536, byte[].class);
    }
    ...
    public final synchronized void reset() {
        ...
        int i = this.d;
        if (-1 == i) {
            throw new RecyclableBufferedInputStream$InvalidMarkException("Mark has been invalidated, pos: " + this.e + " markLimit: " + this.c);
        }
        this.e = i;
    }
