...
public class BottomNavigationMenuView extends NavigationBarMenuView {
    ...
    public BottomNavigationMenuView(Context context) {
        ...
        this.y0 = resources.getDimensionPixelSize(oq6.design_bottom_navigation_item_max_width);
        this.z0 = resources.getDimensionPixelSize(oq6.design_bottom_navigation_item_min_width);
        this.A0 = resources.getDimensionPixelSize(oq6.design_bottom_navigation_active_item_max_width);
        this.B0 = resources.getDimensionPixelSize(oq6.design_bottom_navigation_active_item_min_width);
    }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (getItemIconGravity() == 0) {
            ...
            if (zG && this.C0) {
                ...
                int iMin = Math.min(size - (this.z0 * i8), Math.min(iMax2, i7));
                int i9 = size - iMin;
                int iMin2 = Math.min(i9 / (i8 != 0 ? i8 : 1), this.y0);
                int i10 = i9 - (i8 * iMin2);
                int i11 = 0;
