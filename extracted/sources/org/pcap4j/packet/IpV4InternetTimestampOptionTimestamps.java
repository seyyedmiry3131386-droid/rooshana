...
public final class IpV4InternetTimestampOptionTimestamps implements IpV4InternetTimestampOption.IpV4InternetTimestampOptionData {
    ...
    private IpV4InternetTimestampOptionTimestamps(byte[] bArr, int i, int i2) throws IllegalRawDataException {
        if (i2 % 4 != 0) {
    ...
    public static IpV4InternetTimestampOptionTimestamps newInstance(byte[] bArr, int i, int i2) throws IllegalRawDataException {
        ByteArrays.validateBounds(bArr, i, i2);
        return new IpV4InternetTimestampOptionTimestamps(bArr, i, i2);
    }
