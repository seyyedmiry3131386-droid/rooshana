...
public class PushNotifDialogActivity extends BaseNavigationContentActivity {
    ...
    public final void B(Bundle bundle, String str) {
        super.B(bundle, str);
        if (str.equalsIgnoreCase(k0()) && "DIALOG_KEY_PUSH_NOTIF".equalsIgnoreCase(((DialogDataModel) dt2.p(bundle, "BUNDLE_KEY_DATA", DialogDataModel.class)).b)) {
            finish();
        }
    }
    ...
    public final String C() {
        return getString(rs6.page_name_push_notif);
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        lw.c(stringExtra, "Url is empty");
        d(k0(), this);
        setContentView(js6.nav_content);
        j0();
        DialogDataModel dialogDataModel = new DialogDataModel(k0(), "DIALOG_KEY_PUSH_NOTIF");
        ij5 ij5VarG0 = g0();
        int i = ns6.nav_graph_push_notif;
        new jo6(dialogDataModel, stringExtra, stringExtra2, stringExtra3);
