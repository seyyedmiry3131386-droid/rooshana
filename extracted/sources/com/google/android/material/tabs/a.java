...
public class a {
    public static RectF a(TabLayout tabLayout, View view) {
        ...
        int i = (int) o37.i(tabView.getContext(), 24);
        if (contentWidth < i) {
            contentWidth = i;
        }
    ...
    public void b(TabLayout tabLayout, View view, View view2, float f, Drawable drawable) {
        ...
        drawable.setBounds(yk.c(f, (int) rectFA.left, (int) rectFA2.left), drawable.getBounds().top, yk.c(f, (int) rectFA.right, (int) rectFA2.right), drawable.getBounds().bottom);
    }
}
