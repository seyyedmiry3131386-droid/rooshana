...
public class AndroidDatabaseResults implements DatabaseResults {
    ...
    public int findColumn(String str) throws SQLException {
        ...
        StringBuilder sbN = t61.n("Unknown field '", str, "' from the Android sqlite cursor, not in:");
        sbN.append(Arrays.toString(columnNames));
    ...
    public char getChar(int i) throws SQLException {
        ...
        throw new SQLException(rm7.n(i, "More than 1 character stored in database column: "));
    }
