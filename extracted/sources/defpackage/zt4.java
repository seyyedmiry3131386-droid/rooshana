...
public final class zt4 extends y implements MenuItem {
    public final bc8 c;
    public Method d;

    public zt4(Context context, bc8 bc8Var) {
        super(context);
        if (bc8Var == null) {
    ...
    public final View getActionView() {
        ...
        return actionView instanceof xt4 ? (View) ((xt4) actionView).a : actionView;
    }
    ...
    public final MenuItem setActionProvider(ActionProvider actionProvider) {
        wt4 wt4Var = new wt4(this, actionProvider);
    ...
    public final MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener onActionExpandListener) {
        this.c.setOnActionExpandListener(onActionExpandListener != null ? new yt4(this, onActionExpandListener) : null);
        return this;
    }

    @Override // android.view.MenuItem
    public final MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener onMenuItemClickListener) {
        this.c.setOnMenuItemClickListener(onMenuItemClickListener != null ? new yb8(this, onMenuItemClickListener) : null);
        return this;
    }
    ...
    public final MenuItem setActionView(int i) {
        bc8 bc8Var = this.c;
        bc8Var.setActionView(i);
        View actionView = bc8Var.getActionView();
        if (actionView instanceof CollapsibleActionView) {
            bc8Var.setActionView(new xt4(actionView));
        }
        return this;
    }
}
