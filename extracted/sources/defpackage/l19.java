...
public final class l19 implements ze2 {
    public final /* synthetic */ UserProfileFragment a;

    public l19(UserProfileFragment userProfileFragment) {
    ...
    public final Object emit(Object obj, g51 g51Var) {
        ...
        if (z) {
            ...
            d dVarG = userProfileFragment.J0.g();
            ...
            if (translatedMessage == null || f88.n0(translatedMessage)) {
                translatedMessage = userProfileFragment.K().getString(rs6.error_dto_default_message);
                js3.o(translatedMessage, "getString(...)");
            }
            hh2 hh2Var = new hh2(userProfileFragment.F(), translatedMessage);
            hh2Var.G();
            hh2.H(hh2Var);
        } else if (n99Var instanceof l99) {
            int i2 = UserProfileFragment.c1;
            if (userProfileFragment.J0.g() instanceof ReportDialogFragment) {
                userProfileFragment.J0.q();
            }
            pk5.g(userProfileFragment.J0, new NavIntentDirections.AlertButtonComponent(new dd(new DialogDataModel(userProfileFragment.k1(), "DIALOG_KEY_NO_RESULT", null, 12), null, yq6.ic_thanks_report, null, userProfileFragment.K().getString(rs6.thanks_report_dialog_text), null, userProfileFragment.L(rs6.button_ok), sj8.b().c, sj8.b().d, sj8.b(), 0)), -1);
