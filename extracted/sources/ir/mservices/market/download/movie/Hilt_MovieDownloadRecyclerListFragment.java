...
public abstract class Hilt_MovieDownloadRecyclerListFragment extends PagingRecyclerListContentFragment {
    public r69 f1;
    ...
    public final void A0() {
        ...
        this.h1 = true;
        MovieDownloadRecyclerListFragment movieDownloadRecyclerListFragment = (MovieDownloadRecyclerListFragment) this;
        w91 w91Var = ((t91) ((m25) e())).a;
        movieDownloadRecyclerListFragment.F0 = (d04) w91Var.p.get();
        movieDownloadRecyclerListFragment.G0 = (x57) w91Var.G.get();
        movieDownloadRecyclerListFragment.S0 = (dv2) w91Var.q.get();
        movieDownloadRecyclerListFragment.i1 = (k68) w91Var.V.get();
    }
